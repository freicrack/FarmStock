...
CREATE TABLE `detalle_solicitudes` (
  ...
  PRIMARY KEY (`id_solicitud`,`id_herramienta`),
  KEY `id_herramienta` (`id_herramienta`),
  CONSTRAINT `detalle_solicitudes_ibfk_1` FOREIGN KEY (`id_solicitud`) REFERENCES `solicitudes` (`id`),
  CONSTRAINT `detalle_solicitudes_ibfk_2` FOREIGN KEY (`id_herramienta`) REFERENCES `herramientas` (`id`)
...
-- Dump completed on 2025-07-07 11:16:10
